...
/**
 * Max strategy: Keep highest quantity, source attributes win, combine conditions.
 */
final class MaxMergeStrategy extends AbstractMergeStrategy
{
    ...
    public function mergeItem(CartItem $targetItem, CartItem $sourceItem): array
    {
        return [
            ...
            'quantity' => max($targetItem->quantity, $sourceItem->quantity),
